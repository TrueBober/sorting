...
class SelectSortingTest {
    private SelectSorting selectSorting;

    @BeforeEach
    void setUp() {
        selectSorting = new SelectSorting();
    }

    @Test
    void sort_null_notException() {
        selectSorting.sort(null);
    }
    ...
    void sort_manyNumbers_OK() {
        ...
        //сортировка
        elements = selectSorting.copyAndSort(elements);
    ...
    void reverse_OK() {
        ...
        //сортировка
        selectSorting.reverse(elements);
